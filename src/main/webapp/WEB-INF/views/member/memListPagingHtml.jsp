					...
					<td id="setTd"><div class="d1">
							<ul>
								...
								<path
									...
									<ul>
										<li id="liMemModify" data-memid="${mem.memId }" data-toggle="modal" data-target="#modalEvn"><a href="#" >회원정보수정</a></li>
										<li  id="liReport" data-memid="${mem.memId }" data-toggle="modal" data-target="#modalReEvn"><a href="#">신고사유 조회</a></li>
									</ul></li>
							</ul>
						</div>
					</td>
