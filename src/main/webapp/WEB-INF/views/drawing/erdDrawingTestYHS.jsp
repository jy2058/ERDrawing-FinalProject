...
//            테이블 전체 박스
            ...
            var mini_tb = new Konva.Rect({
				...
				y: circlePos.y*0.048,
				fill: 'black',
				name :entity.id()+''        //메인스테이지 테이블의 id값을 참조함  //네임으로 바꾸자...
				/* opacity: 0.3 */
			});
