...
CREATE TABLE 'TTTTTableName1' ( 
	"Key"	VARCHAR(255)	DEFAULT 122	NULL,
	"Key2"	varchar2(100)	DEFAULT 'F'	NOT NULL,
	"Key3"	number	NOT NULL,
	"Key4"	number   NOT NULL,
	Key5	number   NOT NULL,
);

COMMENT ON COLUMN 'TableName1'.'Key1' IS '1111'; 

ALTER TABLE 'TableName1' ADD CONSTRAINT 'PK_TableName1' PRIMARY KEY( 
'Key2', 
'Key1' 
);
                        </textarea>
